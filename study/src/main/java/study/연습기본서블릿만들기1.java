...
public class 연습기본서블릿만들기1 extends HttpServlet {

	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {

	//우선 인코딩  영어 숫자 외에도 다른 문자도 출력 
	//인코딩하려면 별하나라던가 문자 하나를 나타내야하는데 이 언어들은 1바이트로는 부족하기 때문에
		// UTF-8 로 인코딩해줘야 한다. 
	//그리고 출력스트림을 얻어오기 전에 설정해야 한다!	
		resp.setCharacterEncoding("UTF-8");
		resp.setContentType("text/html;charset=utf-8");
	
		

		//서버는 클라이언트가 보낸 값을 얻어 올 수 있다.	클라이언트가 보낸 정보,요청에 관련한 건 request 
